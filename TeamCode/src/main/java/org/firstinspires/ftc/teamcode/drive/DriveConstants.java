...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 31.279830744754097/130.25; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.039;
    public static double kA = 0.002; // 0.00085 0.00077
    public static double kStatic = 0.09726; // 0.09456 0.10790
     ...
     */
    public static double MAX_VEL = 29; // 29
    public static double MAX_ACCEL = 29; // 29
    public static double MAX_ANG_VEL = Math.toRadians(180);
    public static double MAX_ANG_ACCEL = Math.toRadians(180);

    // set up and down directions
