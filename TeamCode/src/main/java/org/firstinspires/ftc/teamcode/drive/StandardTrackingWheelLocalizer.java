...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.5625; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -9.1875; // in; offset of the lateral wheel
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                new Pose2d(-2.875, LATERAL_DISTANCE / 2, 0), // left
    ...
    public List<Double> getWheelPositions() {
        ...
        return Arrays.asList(
                encoderTicksToInches(leftPos) * X_MULTIPLIER * 1.015,
